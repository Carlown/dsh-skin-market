window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		function hasCatalogPreview(entry) {
			...
			return (hasMarketScreenshots || entry.listScreenshot !== void 0 || entry.screenshots.length > 0) && (hasMarketScreenshots || entry.review?.preview !== "repository-card");
		}
...
收录不等于安全认证。不要声称该皮肤已被 DSH 官方、安全团队或市场背书。`;
		...
		function PreviewMedia({ skin, src, alt, kind, loading }) {
			...
			if (!((skin.marketScreenshots?.length ?? 0) > 0) && skin.review?.preview === "repository-card" || src === void 0 || failed) return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
		...
		function SkinMarketSection({ t, clientRuntime, catalogCache = browserCatalogCache }) {
			...
			const [operationClock, setOperationClock] = (0, react.useState)(Date.now());
			...
			const openRestartConfirm = (0, react.useCallback)(async (skinId, kind = "skin") => {
				setError(null);
			...
			(0, react.useEffect)(() => {
				...
				const timer = window.setInterval(() => setOperationClock(Date.now()), 1e3);
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("section", {
				...
				children: [
						...
						children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("header", {
							...
							children: [
								...
								busy !== null && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
									className: `${SkinMarket_module_css_default.operation} ${SkinMarket_module_css_default.homeOperation}`,
									role: "status",
									children: [
												...
												return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(_deepseek_ai_dsh_client_ui_primitives.Button, {
													...
													children: [
														...
														/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
															...
															children: mutationLabel ?? (itemState.activation === "active" ? compactStatusLabel(itemState) : itemState.updateAvailable ? "可更新" : itemState.installation === "missing" && skin.review?.installation === "manual-only" ? "手动安装" : compactStatusLabel(itemState))
														})
													]
												}, skin.id);
											}),
									...
									children: loading ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
										...
										busy !== null && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
											...
											children: [
												...
												/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("strong", { children: [
													phases[busy.phase],
													"“",
													skins.find((skin) => skin.id === busy.skinId)?.name.zh ?? busy.skinId,
													"”"
												] }),
												/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
													className: SkinMarket_module_css_default.operationMeta,
													children: operationMeta(busy, operationClock).map((item) => /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("small", { children: ["· ", item] }, item))
												}),
												busy.cancelable === true && /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.Button, {
										...
										/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
											...
											children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
												...
												"aria-label": "截图选择",
												children: selected.screenshots.map((shot, index) => /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(_deepseek_ai_dsh_client_ui_primitives.Button, {
						...
						children: [
							...
							/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
								...
								children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(PreviewMedia, {
									...
									kind: "hero"
								}, `${selected.id}:${selected.screenshots[shotIndex] ?? selected.screenshots[0] ?? "missing"}:lightbox`)
							}),
							shotCount > 1 && /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.Button, {
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.Modal, {
						...
						title: restartTarget?.kind === "market-update" ? "需要重启 DSH 应用皮肤市场更新" : "需要重启 DSH 应用此皮肤",
						closeLabel: "关闭",
