...
收录不等于安全认证。不要声称该皮肤已被 DSH 官方、安全团队或市场背书。`;
		...
		function SkinMarketSection({ t, clientRuntime, catalogCache = browserCatalogCache }) {
			...
			const installedIds = (0, react.useMemo)(() => new Set(installedSkins.map((skin) => skin.id)), [installedSkins]);
			const discoverySkins = (0, react.useMemo)(() => skins.filter((skin) => {
				if (!`${skin.name.zh} ${skin.name.en} ${skin.author} ${skin.tags.join(" ")}`.toLowerCase().includes(homeQuery.trim().toLowerCase())) return false;
				...
				children: [
						...
						children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("header", {
							...
							children: [homeQuery.trim() === "" && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("section", {
								...
								children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
									...
									children: [installedRowSkins.map((skin) => {
										...
										return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(_deepseek_ai_dsh_client_ui_primitives.Button, {
											...
											"aria-label": `${skin.name.zh} 界面预览`,
											onClick: () => openInstalledBrowser(skin.id),
											children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)(PreviewMedia, {
												...
												children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("strong", { children: skin.name.zh }), /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("small", { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { children: skin.author }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
													className: itemState.activation === "active" ? `${SkinMarket_module_css_default.cardStatus} ${SkinMarket_module_css_default.cardStatusActive}` : itemState.updateAvailable ? `${SkinMarket_module_css_default.cardStatus} ${SkinMarket_module_css_default.cardStatusUpdate}` : SkinMarket_module_css_default.cardStatus,
													children: itemState.activation === "active" ? "使用中" : itemState.updateAvailable ? "可更新" : "已安装"
												})] })]
											})]
										}, skin.id);
									}), installedOverflow && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(_deepseek_ai_dsh_client_ui_primitives.Button, {
										variant: "ghost",
								...
								children: [
									...
									catalogLoading && skins.length === 0 ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
										...
										children: visibleDiscoverySkins.map((skin, index) => {
											const itemState = runtimeFor(states, skin.id);
											return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(_deepseek_ai_dsh_client_ui_primitives.Button, {
												variant: "ghost",
												className: SkinMarket_module_css_default.homeCard,
												"data-feed-size": index % 3,
												"aria-label": `${skin.name.zh} 界面预览`,
												onClick: () => openBrowser(skin.id, "discover"),
												children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)(PreviewMedia, {
													skin,
													src: skin.listScreenshot ?? skin.screenshots[0],
													alt: `${skin.name.zh} 界面预览`,
													...
													className: SkinMarket_module_css_default.homeCardCopy,
													children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("strong", { children: skin.name.zh }), /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("small", { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { children: skin.author }), /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
														...
														children: [
															...
															/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
																...
																children: itemState.installation === "missing" ? "可安装" : statusLabel(itemState)
															})
														]
													})] })]
												})]
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.Modal, {
						...
						children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
							...
							})] }), /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("strong", { children: "命令" }), /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
								className: SkinMarket_module_css_default.copyCapsule,
								children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("code", {
