...
export function logEvent(level: LogLevel, event: string, detail: string, operationId?: string): void {
  entries.push({
...
export function exportLogs(header: Record<string, string>, operationId?: string): string {
