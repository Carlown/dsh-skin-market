...
export function applicableAdapters(skin, runtime, includeBuiltIns) {
    ...
    return uniqueAdapters.filter(adapter => satisfiesVersionRange(runtime.version, adapter.when)
